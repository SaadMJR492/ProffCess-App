...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='csvimport',
            name='upload_file',
            field=models.FileField(storage=django.core.files.storage.FileSystemStorage(location='C:\\Users\\Saad Mujawar\\Dropbox\\My PC (LAPTOP-VTOH803K)\\Desktop\\Profcess_intern\\profcess_dev-2.0\\media'), upload_to='csv'),
        ),
        migrations.CreateModel(
            name='Item',
            fields=[
